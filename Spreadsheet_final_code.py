...
# The code can display the months with most and least expenses, along with the expenses value.
m_l_ex = input('Would you like to see the months with the most and least expenses? y/n')
if m_l_ex == 'y':
    ...
    def run():
        global least_expenditure, most_expenditure
        data = read_data()
        sales = {}
...
m = input('Would you like to see the graphs? y/n')
if m == 'y':
